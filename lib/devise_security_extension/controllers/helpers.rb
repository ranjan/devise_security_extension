    ...
    module Helpers
      ...
      # controller instance methods
        ...
        def redirect_for_password_change(scope)
          redirect_to change_password_required_path_for(scope), :alert => I18n.t('devise.password_expired.change_required')
        end

        def redirect_for_paranoid_verification(scope)
          redirect_to paranoid_verification_code_path_for(scope), :alert => I18n.t('devise.paranoid_verify.code_required')
        end
